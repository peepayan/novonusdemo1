...
ARM_PREGRIP_QPOS: tuple[float, ...] = (
    -0.2357, -1.0432, 1.8240, -1.9017, -1.6214, 0.0,
)
ARM_GRIP_QPOS: tuple[float, ...] = (
    -0.2372, -0.8994, 1.8045, -1.9277, -1.6141, 0.0,
)
ARM_STABILIZE_QPOS: tuple[float, ...] = (
    -0.2352, -1.0981, 1.8261, -1.8940, -1.6236, 0.0,
)
ARM_RELEASE_QPOS: tuple[float, ...] = (
    0.0248, -0.8544, 1.7576, -1.9507, -1.5549, 0.0,
)
